          ...
          <div class="row row-50">
            <div class="col-lg-4 col-xl-3">
              <div class="aside row row-30 row-md-50 justify-content-md-between">
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  <h6 class="aside-title"><asp:Label ID="lblMainCategoryName" runat="server" Text=""></asp:Label></h6>
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div>
                  <div class="group-sm group-middle">
                    ...
                    <div class="product-view-toggle"><a class="mdi mdi-apps product-view-link product-view-grid active" href="grid-shop.html"></a><a class="mdi mdi-format-list-bulleted product-view-link product-view-list" href="#"></a></div>
                                      ...
                                      <h6 class="aside-title"><asp:Label ID="lblProductList" runat="server" Text="Label"></asp:Label></h6>
                                    <h6><asp:Label ID="lblFeaturedItems" runat="server" Text="Label">Featured Items</asp:Label></h6>
              ...
              <div class="row row-30 row-lg-50">
                            ...
                            <asp:Repeater ID="rpProduct" runat="server" DataSourceID="SqlDSProductList">
                            <ItemTemplate>
